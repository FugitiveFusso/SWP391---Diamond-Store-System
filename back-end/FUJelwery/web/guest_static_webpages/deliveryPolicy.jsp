            ...
            <div class="content">
                ...
                <div class="four">
                    ...
                    <ul class="b">
                        ...
                        <li>The above delivery time is for reference only, the actual delivery time may fluctuate sooner or later depending on product inventory status, delivery address and some objective conditions that KHAC cannot control ( For example: natural disasters, floods, vehicle breakdowns...).</li>               
                    </ul>                  
                </div>
