    ...
    <body>
        ...
        <div class="container d-flex justify-content-center align-items-center">
            <div class="text-center">
                <h1 style="font-size: 50px; font-weight: 700">Sale Staff Account</h1>
                            ...
                            <div class="row no-gutters">
                                <div class="col-md-3 bg-c-lite-green user-profile">
                                    <div class="card-block text-center text-white">
                                        ...
                                        <p style="color: #fff; font-family: 'Inter'; font-size: 12px;">Sales Staff of KHAC Diamond Ring Shop</p>
                                        <p style="color: #fff; font-family: 'Inter'; font-size: 11px;">${sessionScope.salessession.username}</p>
