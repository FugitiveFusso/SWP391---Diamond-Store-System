    ...
    <body>
        ...
        <div class="side-bar">
            <header>
                ...
                <h1>${requestScope.usersession.userName}</h1>
            </header>
                ...
                <div class="list">
                    ...
                    <table id="pagination">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <a href="BillController?action=details&id=${bill.orderID}">   ${bill.orderID}</td>
                                <td>${bill.ringName}</td>
                                <td>${bill.ringSize}</td>
                                <td>${bill.voucherName}</td>
                                <td>${bill.certificateName}</td>
                                <td>${bill.warrantyName}</td>
