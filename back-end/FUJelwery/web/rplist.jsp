                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th><a href="?colSort=rName<%= request.getAttribute("keyword") != null && !request.getAttribute("keyword").toString().isEmpty() ? "&keyword=" + request.getAttribute("keyword") : ""%>">Ring Placement Name</a></th>
                                <th><a href="?colSort=material<%= request.getAttribute("keyword") != null && !request.getAttribute("keyword").toString().isEmpty() ? "&keyword=" + request.getAttribute("keyword") : ""%>">Material</a></th>
                                ...
                                <th><a href="?colSort=rpPrice<%= request.getAttribute("keyword") != null && !request.getAttribute("keyword").toString().isEmpty() ? "&keyword=" + request.getAttribute("keyword") : ""%>">Price</a></th>
                                <th>Delete</th>
