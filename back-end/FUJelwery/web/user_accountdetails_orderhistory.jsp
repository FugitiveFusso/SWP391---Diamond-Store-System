...
<html>
    ...
    <body>
            ...
            <div class="header-top">
                <div class="top-info-left">
                    <ul>
                        ...
                        <li style="margin-left: 5px; padding-top: 5px">at KHAC Diamond Ring Online Shop.</li>                         
                    </ul>
                </div>
                                    ...
                                    <div class="panel">
                                        <div class="panel-body">
                                            <table class="order-history-table">
                                                ...
                                                <tbody id="store-received-orders-body">
                                                    <%
        ...
        <script src="js/user_accountdetails_orderhistory.js"></script>
