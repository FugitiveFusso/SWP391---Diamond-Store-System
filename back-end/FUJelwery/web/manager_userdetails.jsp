...
<<<<<<< HEAD
                                        ...
                                        <p style="color: #fff; font-family: 'Inter'; font-size: 13px;">${requestScope.user.rolename} of KHAC Diamond Ring Shop</p>
                                    ...
                                    <div class="card-block">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <h6 class="text-muted f-w-400">${requestScope.user.firstname}</h6>
                                            </div>
                                            <div class="col-sm-6">
                                                <p class="m-b-10 f-w-600">Last Name</p>
                                                <h6 class="text-muted f-w-400">${requestScope.user.lastname}</h6>
                                            </div>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="row" style="margin-top: 20px; justify-content: center">
                                            <div class="col-sm-4">
                                                <form action="DashboardController" style="padding-top: 10px">
