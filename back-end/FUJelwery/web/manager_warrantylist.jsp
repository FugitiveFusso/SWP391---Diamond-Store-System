                ...
                <div class="list">
                    ...
                    <table id="pagination">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th><a href="?action=listofwarranty&colSort=warrantyName<%= request.getAttribute("keyword") != null && !request.getAttribute("keyword").toString().isEmpty() ? "&keyword=" + request.getAttribute("keyword") : ""%>">Name</a></th>
                                <th>Image</th>
                        ...
                        <tbody>
                            ...
                            %>
                            <tr>
                                <td style="text-align: center"><a href="DashboardController?action=warrantydetails&id=${warranty.id}">${warranty.id}</a></td>
                    ...
                    <div class="pagination">
                        ...
                        <% if (currentPage > 1) {%>
                        <a href="?action=listofwarranty&page=<%= currentPage - 1%><%= !sortCol.isEmpty() ? "&colSort=" + sortCol : ""%><%= !keyword.isEmpty() ? "&keyword=" + keyword : ""%>" class="pagination-arrow">&#8249;</a>
                        <% } else { %>
                        ...
                        <%
                            ...
                            if (startPage > 1) {%>
                        <a href="?action=listofwarranty&page=1<%= !sortCol.isEmpty() ? "&colSort=" + sortCol : ""%><%= !keyword.isEmpty() ? "&keyword=" + keyword : ""%>" class="pagination-number">1</a>
                        <% if (startPage > 2) { %>
                        ...
                        <a href="?action=listofwarranty&page=<%= i%><%= !sortCol.isEmpty() ? "&colSort=" + sortCol : ""%><%= !keyword.isEmpty() ? "&keyword=" + keyword : ""%>"
                        ...
                        <span class="pagination-ellipsis">...</span>
                        <% }%>
                        <a href="?action=listofwarranty&page=<%= totalPages%><%= !sortCol.isEmpty() ? "&colSort=" + sortCol : ""%><%= !keyword.isEmpty() ? "&keyword=" + keyword : ""%>" class="pagination-number"><%= totalPages%></a>
                        <% }
                        %>
