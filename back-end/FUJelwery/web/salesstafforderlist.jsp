            ...
            <div class="smaller-container">
                ...
                <div class="list">
                    ...
                    <table>
                        ...
                        <tr>
                            <td>${order.orderID}</td>
                            <td><a href="Staff_Customer_Controller?action=details&id=${order.userID}">${order.userName}</td>
                            <td>${order.ringName}</td>
                            <td>${order.ringSize}</td>
                            <td>${order.orderDate}</td>
                            <td>${order.address}</td>
                            <td>
                                <input type="text" name="warrantyID" id="warrantyID_${order.warrantyID}" placeholder="Enter Warranty ID" required>
                            </td>
