                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">    
                            ...
                            <p class="card-text"><strong>Warranty Name:</strong> <a href="WarrantyController?action=details&id=${requestScope.ring.warrantyID}">${requestScope.ring.warrantyName}</a></p>
