    ...
    <body>
        ...
        <div class="container d-flex justify-content-center align-items-center">
            <div class="text-center">
                <h1 style="font-size: 50px; font-weight: 700">Admin Account</h1>
                            ...
                            <div class="row no-gutters">
                                <div class="col-md-3 bg-c-lite-green user-profile">
                                    <div class="card-block text-center text-white">
                                        ...
                                        <h6 class="f-w-600"style="font-size: 18px; margin: 10px 0;">${sessionScope.adminsession.lastname} ${sessionScope.adminsession.firstname}</h6>
                                        <p style="color: #fff; font-family: 'Inter'; font-size: 12px;">Admin of KHAC Diamond Ring Shop</p>
                                        <p style="color: #fff; font-family: 'Inter'; font-size: 11px;">${sessionScope.adminsession.username}</p>
                                    ...
                                    <div class="card-block">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <h6 class="text-muted f-w-400">${sessionScope.adminsession.firstname}</h6>
                                            </div>
                                            <div class="col-sm-6">
                                                <p class="m-b-10 f-w-600">Last Name</p>
                                                <h6 class="text-muted f-w-400">${sessionScope.adminsession.lastname}</h6>
                                            </div>
                                            <div class="col-sm-6">
                                                <p class="m-b-10 f-w-600">Email</p>
                                                <h6 class="text-muted f-w-400">${sessionScope.adminsession.email}</h6>
                                            </div>
                                            <div class="col-sm-6">
                                                <p class="m-b-10 f-w-600">Phone Number</p>
                                                <h6 class="text-muted f-w-400">${sessionScope.adminsession.phonenumber}</h6>
                                            </div>
                                            <div class="col-sm-6">
                                                <p class="m-b-10 f-w-600">Address</p>
                                                <h6 class="text-muted f-w-400">${sessionScope.adminsession.address}</h6>
                                            </div>
                                            <div class="col-sm-6">
