                ...
                <div class="list">
                    ...
                    <table id="pagination">
                        <thead>
                            <tr>
                                <th>Ring ID</th>
                                <th><a href="?colSort=ringName<%= request.getAttribute("keyword") != null && !request.getAttribute("keyword").toString().isEmpty() ? "&keyword=" + request.getAttribute("keyword") : ""%>">Ring Name</th>
                                <th>Ring Image</th>
                                ...
                                <th><a href="?colSort=price<%= request.getAttribute("keyword") != null && !request.getAttribute("keyword").toString().isEmpty() ? "&keyword=" + request.getAttribute("keyword") : ""%>">Price</th>
                                <th><a href="?colSort=categoryID<%= request.getAttribute("keyword") != null && !request.getAttribute("keyword").toString().isEmpty() ? "&keyword=" + request.getAttribute("keyword") : ""%>">Category</th>
                                <th><a href="?colSort=collectionID<%= request.getAttribute("keyword") != null && !request.getAttribute("keyword").toString().isEmpty() ? "&keyword=" + request.getAttribute("keyword") : ""%>">Collection</th>
                                <th>Delete</th>
                            </tr>
                        </thead>
                        <tbody>
