                ...
                <div class="list">
                    ...
                    <table id="pagination">
                        <thead>
                            <tr>
                                <th>Collection ID</th>
                                <th><a href="?colSort=collectionName<%= request.getAttribute("keyword") != null && !request.getAttribute("keyword").toString().isEmpty() ? "&keyword=" + request.getAttribute("keyword") : ""%>">Collection Name</a></th>
