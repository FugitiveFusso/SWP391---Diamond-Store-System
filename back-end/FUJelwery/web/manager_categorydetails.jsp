    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="pagination">
                ...
                <% if (currentPage > 1) {%>
                <a href="?action=categorydetails&id=<%=id%>&page=<%= currentPage - 1%><%= !sortCol.isEmpty() ? "&colSort=" + sortCol : ""%><%= !keyword.isEmpty() ? "&keyword=" + keyword : ""%>" class="pagination-arrow">&#8249;</a>
                <% } else { %>
                ...
                <%
                    ...
                    if (startPage > 1) {%>
                <a href="?action=categorydetails&id=<%=id%>&page=1<%= !sortCol.isEmpty() ? "&colSort=" + sortCol : ""%><%= !keyword.isEmpty() ? "&keyword=" + keyword : ""%>" class="pagination-number">1</a>
                <% if (startPage > 2) { %>
                ...
                <a href="?action=categorydetails&id=<%=id%>&page=<%= i%><%= !sortCol.isEmpty() ? "&colSort=" + sortCol : ""%><%= !keyword.isEmpty() ? "&keyword=" + keyword : ""%>"
                ...
                <span class="pagination-ellipsis">...</span>
                <% }%>
                <a href="?action=categorydetails&id=<%=id%>&page=<%= totalPages%><%= !sortCol.isEmpty() ? "&colSort=" + sortCol : ""%><%= !keyword.isEmpty() ? "&keyword=" + keyword : ""%>" class="pagination-number"><%= totalPages%></a>
                <% }
                %>
