                        ...
                        <form action="OrderController" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-50">
                                    ...
                                    <input type="text" id="expmonth" name="expmonth" placeholder="Please enter your exp month" minlength="2" maxlength="2" required pattern="0[1-9]|1[0-2]" title="Please enter a month between 01 and 12">

                                    <div class="row">
                                        <div class="col-50">
                                            <label for="expyear">Exp Year</label>
                                            <input type="text" id="expyear" name="expyear" placeholder="Please enter your exp year" minlength="4" maxlength="4" required pattern="\d{4}" title="Please enter a valid four-digit year">
                                        </div>

                                        <div class="col-50">
                                            <label for="cvv">CVV</label>
                                            <input name="VVS" type="text" class="search-input" value="" minlength="3" maxlength="3" required pattern="\d{3}" placeholder="Please enter CVV" title="Please enter a valid three-digit CVV number">
                                        </div>
