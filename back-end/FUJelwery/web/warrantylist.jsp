                ...
                <div class="list">
                    ...
                    <table>
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th><a href="?colSort=warrantyName<%= request.getAttribute("keyword") != null && !request.getAttribute("keyword").toString().isEmpty() ? "&keyword=" + request.getAttribute("keyword") : ""%>">Name</a></th>
                                <th>Image</th>
