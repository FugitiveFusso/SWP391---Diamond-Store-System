...
@WebServlet(name = "SalesStaffLoginController", urlPatterns = {"/saleslogin"})
public class SalesStaffLoginController extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (action == null || action.equals("login")) {
                ...
                if (user != null) {
                    ...
                    response.sendRedirect("./SalesStaffOrderController");
                } else {
