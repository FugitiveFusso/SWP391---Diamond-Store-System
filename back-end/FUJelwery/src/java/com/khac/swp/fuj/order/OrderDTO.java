...
public class OrderDTO {
    ...
    public int getTotalOrderDetails() {
        return totalOrderDetails;
    }

    public void setTotalOrderDetails(int totalOrderDetails) {
