 ...
 * @author phucu
 */
public class GuestPostController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (action == null || action.equals("list")) {//lists
                ...
                request.getRequestDispatcher("./guestpostlist.jsp").forward(request, response);
                ...
                RequestDispatcher rd = request.getRequestDispatcher("./guestpostdetails.jsp");
