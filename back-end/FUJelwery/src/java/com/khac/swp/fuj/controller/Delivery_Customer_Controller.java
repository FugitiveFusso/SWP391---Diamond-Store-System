 ...
 * @author Dell
 */
@WebServlet(name = "Delivery_Customer_Controller", urlPatterns = {"/Delivery_Customer_Controller"})
public class Delivery_Customer_Controller extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (session == null || session.getAttribute("deliverystaffsession") == null) {
                ...
                RequestDispatcher rd = request.getRequestDispatcher("deliverystaff_customerdetails.jsp");
